...
Pod::Spec.new do |s|
  ...
  s.subspec 'lib' do |ss|
    ...
    ss.resources = 'Sources/CAMobileAppAnalytics/Classes/*.js'
    ss.vendored_libraries = 'Sources/CAMobileAppAnalytics/Classes/*.a'
  end

  s.subspec 'xcframework' do |ss|
    ss.source_files = 'Sources/CAMobileAppAnalytics/CAMobileAppAnalytics.xcframework/ios-arm64_arm64e_armv7_armv7s/Headers/*.{h}'
    ss.public_header_files = 'Sources/CAMobileAppAnalytics/CAMobileAppAnalytics.xcframework/ios-arm64_arm64e_armv7_armv7s/Headers/*.{h}'
    ss.resources = 'Sources/CAMobileAppAnalytics/Classes/*.js'
